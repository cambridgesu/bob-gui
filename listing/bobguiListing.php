...
class bobguiListing extends frontControllerApplication
{
	...
	protected $defaults = array (
		...
		'administratorEmail' => 'webmaster' . '@cusu.cam.ac.uk',
	...
	function home ()
	{
		# Opening text
		$html  = "\n" . '<h1>Welcome</h1>';
		$html .= "\n" . '<p>Welcome to the CUSU voting portal. Here you can submit a vote on existing ballots that you have voting rights for, or create a new ballot if you run a University-based group.</p>';
	...
	protected function controlpanel ()
	{
		# Start the HTML
		$html  = "\n<div class=\"graybox\">";
		$html .= "\n<p><strong>To add new ballots or administer newly-created ones for which you have administrative rights, you need to use the <a href=\"{$this->settings['controlPanelUrl']}\">Control Panel on the main CUSU website</a>.</strong></p>";
	...
	private function currentBallotsListing ()
	{
		...
		if (!$currentBallots = $this->getBallotInstances (false, false, false, true, $currentBallotsOnly = true)) {
			...
			# Compile the HTML
			$html  = "\n<p>The following online ballots are currently taking place.<br />The closing time of online voting for each ballot is also shown.</p>";
