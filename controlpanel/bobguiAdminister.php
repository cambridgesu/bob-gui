	...
	private function ballotConfigurationForm ($data, &$html, $organisation = array ())
	{
		...
		$form->dataBinding (array (
			...
			'attributes' => array (
				...
				'frontPageMessageHtml' => array ('title' => 'Optional front-page message (not usually required)', 'description' => 'Normally leave this blank. Useful if you want to give some kind of extra message about the vote. URLs will become automatically hyperlinked.', 'size' => 80, ),
