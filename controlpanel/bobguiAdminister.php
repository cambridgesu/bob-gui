...
class bobguiAdminister extends frontControllerApplication
{
	...
	private function addballot ($organisation)
	{
		...
		if ($ballot = $this->ballotConfigurationForm ($data = array (), $html, $organisationData)) {
	...
	private function ballotConfigurationForm ($data, &$html, $organisation = array ())
	{
		...
		$form->dataBinding (array (
			...
			'attributes' => array (
				...
				'urlSlug' => array ('editable' => (!$isEditMode), 'maxlength' => 20, 'size' => 20, 'regexp' => $this->settings['uniqueIdRegexp'], 'description' => "This is a identifier for this election, e.g. 'mainelection', 'committee', which must be unique for the current academic year.<br />It must be 3-20 characters, all lower-case a-z, with no numbers.<br />It will appear at the end of the URL, and cannot be changed later.", 'prepend' => "<span class=\"formprepend\">/{$organisationId}/&lt;academic-year&gt;/</span>", 'append' => "<span class=\"formappend\">/", ),
				...
				'urlMoreInfo' => array ('regexp' => '^(http|https)://', 'description' => 'If you have a webpage giving more info about candidates, etc., enter the address starting http:// (or https://) here.', 'size' => 70, ),
				#!# size=80 being ignored
				'afterVoteMessageHtml' => array ('description' => 'Normally leave this blank. Useful if you want to point people to a second concurrent election. URLs will become automatically hyperlinked.', 'size' => 80, ),
				'frontPageMessageHtml' => array ('description' => 'Normally leave this blank. Useful if you want to give some kind of extra message about the vote. URLs will become automatically hyperlinked.', 'size' => 80, ),
				...
				'electionInfoAsEntered' => array ('heading' => array ('' => $randomisationHelp, ), 'cols' => 100, 'rows' => 20, 'description' => 'See the diagram above. Precise checks will be done.', ),
			),
		));
